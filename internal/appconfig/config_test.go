...
func TestDefaultsAndEnvironmentOverrides(t *testing.T) {
	...
	want := Config{ArkdURL: "https://mutinynet.arkade.sh",
		EmulatorURL: "https://emulator.mutinynet.arkade.sh", IndexerURL: "https://mutinynet.arkade.sh",
	...
	values = map[string]string{"POKER_STAKE": "", "POKER_ARKD_URL": ""}
	c, err = load()
	if err != nil || c.ArkdURL != "https://mutinynet.arkade.sh" || c.Terms.Stake != 5000 {
